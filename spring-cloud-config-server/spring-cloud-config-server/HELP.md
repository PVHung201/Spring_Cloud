...
* The original package name 'com.microservice.spring-cloud-config-server' is invalid and this project uses 'com.microservice.spring_cloud_config_server' instead.
